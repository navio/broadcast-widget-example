...
var WidgetController = (function (_Widget) {
  _inherits(WidgetController, _Widget);

  function WidgetController(name, dispatcher, widgetTools) {
    _classCallCheck(this, WidgetController);

    _get(Object.getPrototypeOf(WidgetController.prototype), "constructor", this).call(this, name, dispatcher);
